...
export default function OrderPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    // The buyer-surface wrapper and nav live in app/buyer/layout.tsx.
    <div>
      <div className="mx-auto max-w-2xl px-4 py-6">
        ...
        >
          <ArrowLeft className="h-4 w-4" aria-hidden /> Back to your orders
        </Link>
        ...
        {err ? (
          ...
          <div className="mt-4 space-y-4">
            ...
            {/* The seller's side of this thread is their inbox — same rows, other end. */}
            <MessageThread
              orderId={bundle.order.id}
              skin="light"
              emptyHint="Ask the seller anything about this order — they'll see it in their inbox."
            />
          </div>
        )}
      </div>
