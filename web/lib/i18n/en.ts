...
export const en = {
  ...
  "flow.sizing.subtitle": "Lay the garment flat with an A4 sheet (or a measuring tape) in frame for scale. One photo → real centimetres, no manual entry.",
  "flow.sizing.a4": "A4 sheet",
  "flow.sizing.tape": "Measuring tape",
  "flow.sizing.choosePhoto": "Click to choose flat-lay photo",
